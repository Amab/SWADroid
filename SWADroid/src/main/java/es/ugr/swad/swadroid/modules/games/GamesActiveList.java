 ...
 */
public class GamesActiveList extends MenuExpandableListActivity
     ...
     * Handler for games
     */
    private final GamesActiveList.RefreshAdapterHandler mHandler =
            new GamesActiveList.RefreshAdapterHandler(this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        switch (requestCode) {
            case Constants.MATCHES_ACTIVE_DOWNLOAD_CODE:
                mProgressScreen.hide();
                Intent activity;
                activity = new Intent(getApplicationContext(), MatchesActiveList.class);
    ...
    private void refreshGames() {
        mProgressScreen.show();
        Intent activity = new Intent(this, GamesActive.class);
