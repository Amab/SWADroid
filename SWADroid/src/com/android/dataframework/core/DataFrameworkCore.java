...
public class DataFrameworkCore {
    ...
    private final ArrayList<String> mLanguages = new ArrayList<String>();
                        ...
                        if (eventType == XmlPullParser.START_TAG) {
                            if (x.getName().equals("database")) {
                                ...
                                if (x.getAttributeValue(null, "to-string") != null)
                                    currentTable.setToString(x.getAttributeValue(null, "to-string"));
                                ...
                                if (x.getAttributeValue(null, "foreign-table") != null)
                                    currentField.setForeignTable(x.getAttributeValue(null, "foreign-table"));
                                if (x.getAttributeValue(null, "obligatory") != null) {
                                    if (x.getAttributeValue(null, "obligatory").equals("true"))
                                        currentField.setObligatory(true);
                                }
                                if (x.getAttributeValue(null, "size") != null)
                                    currentField.setSize(Integer.parseInt(x.getAttributeValue(null, "size")));
                                if (x.getAttributeValue(null, "default") != null)
                                    currentField.setTextDefault(x.getAttributeValue(null, "default"));
                                if (x.getAttributeValue(null, "new-in-version") != null) {
     ...
     */
    public void backup(String file, boolean forceBackup) throws IOException {
     ...
     */
    public void restore(String file) throws XmlPullParserException {
        try {
    ...
    private void insertXML(XmlPullParser x) {
        try {
                        ...
                        if (x.getAttributeValue(null, "lang") != null) {
                            if ((x.getAttributeValue(null, "name") != null) && (x.getAttributeValue(null, "value") != null)) {
                                if (currenEntity != null)
                                    currenEntity.setMultilanguageValue(x.getAttributeValue(null, "name"),
