...
public class DataFramework {
    ...
    private static DataFramework mDataFramework = null;

    private int mOpenInstances = 0;

    private final ArrayList<Table> mTables = new ArrayList<Table>();

    private final DataFrameworkCore mCore;
    ...
    ArrayList<Entity> getEntityList(String table, String where, String orderby, String limit) {
