        ...
        if (result != null) {
            ...
            for (int i = 0; i < numNotif; i++) {
                ...
                SWADNotification n = new SWADNotification(notifCode, eventCode, eventType,
                        eventTime, userSurname1, userSurname2, userFirstName, userPhoto, location,
                        summary, status, content, notifReadSWAD, notifReadSWAD);
            ...
            try {
                ...
                if (e instanceof SoapFault) {
                    ...
                    switch (httpStatusCode) {
                        case 500:
                            errorMessage = mContext.getString(R.string.errorInternalServerMsg);
                            break;
