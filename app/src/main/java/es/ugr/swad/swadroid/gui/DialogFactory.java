...
public class DialogFactory {
     ...
     * @return AlertDialog with the HTML content loaded
     */
    public static AlertDialog createWebViewDialog(Context context, int titleId,
     ...
     */
    public static AlertDialog createNeutralDialog(Context context, int layoutId, int titleId,
            int messageId,
     ...
     */
    public static AlertDialog createPositiveNegativeDialog(Context context, int iconId,
            int layoutId, int titleId,
            int messageId, int acceptLabel, int cancelLabel, boolean cancelable,
     ...
     *                        false otherwise
     * @param isDebuggable    true if the application is debuggable (develop mode). Activates Logcat
     *                        messages
     *                        false otherwise
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static AlertDialog createErrorDialog(Context context, String tag, String message,
            Exception ex,
