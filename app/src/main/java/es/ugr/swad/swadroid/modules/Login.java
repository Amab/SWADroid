...
public class Login extends Module {
     ...
     *
     * @param userRole Role of the user: 0- unknown STUDENT_TYPE_CODE - student TEACHER_TYPE_CODE -
     *                 teacher
     */
    public static void setCurrentUserRole(int userRole) {
        if (userRole == 0 || userRole == Constants.TEACHER_TYPE_CODE
                || userRole == Constants.STUDENT_TYPE_CODE) {
