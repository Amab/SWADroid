...
public class DataFramework {
    ...
    public String getStringFromIdentifier(String name) {
        int id = mCore.getContext().getResources()
                .getIdentifier(mCore.getPackage() + ":string/" + name, null, null);
        if (id != 0) {
    ...
    public Cursor getCursor(String table, String[] fields, String selection,
        ...
        return mCore.getDB()
                .query(table, fields, selection, selectionArgs, groupby, having, orderby, limit);
    }
